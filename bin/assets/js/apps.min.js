...
var generateSlimScroll=function(e){var t=$(e).attr("data-height");t=!t?$(e).height():t;var n={height:t,alwaysVisible:true};if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){n.wheelStep=1;n.touchScrollStep=100}$(e).slimScroll(n)};
...
var handleThemePanelExpand=function(){$('[data-click="theme-panel-expand"]').live("click",function(){var e=".theme-panel";var t="active";if($(e).hasClass(t)){$(e).removeClass(t)}else{$(e).addClass(t)}})};
...
var handleSidebarMenu=function(){
	...
	$(".sidebar .nav > .has-sub .sub-menu li.has-sub > a").click(function(){
		//if($(".page-sidebar-minified").length===0){var e=$(this).next(".sub-menu");$(e).slideToggle(250)}
	})
};
...
var handleSidebarMinify=function(){
	$("[data-click=sidebar-minify]").click(function(e){
		...
		if($(n).hasClass(t)){
			$(n).removeClass(t);if($(n).hasClass("page-sidebar-fixed")){generateSlimScroll($('#sidebar [data-scrollbar="true"]'))}
		}else{
			$(n).addClass(t);
			if($(n).hasClass("page-sidebar-fixed")){
				$('#sidebar [data-scrollbar="true"]').slimScroll({destroy:true});$('#sidebar [data-scrollbar="true"]').removeAttr("style")
			};
...
var handleMobileSidebarToggle=function(){
	alert('handleMobileSidebarToggle');
...
var handleAfterPageLoadAddClass=function(){
	alert('handleAfterPageLoadAddClass');
...
var App=function(){"use strict";return{
	init:function(){
		//handleSlimScroll();
		//handleSidebarMenu();
