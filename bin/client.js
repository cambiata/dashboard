...
nx3.xml.NoteXML.test = function(item) {
	...
	haxe.Log.trace(str,{ fileName : "NoteXML.hx", lineNumber : 221, className : "nx3.xml.NoteXML", methodName : "test"});
	haxe.Log.trace(str2,{ fileName : "NoteXML.hx", lineNumber : 222, className : "nx3.xml.NoteXML", methodName : "test"});
	return str == str2;
};
