...
$hxClasses["ExerciseIntervals"] = ExerciseIntervals;
ExerciseIntervals.__name__ = ["ExerciseIntervals"];
...
var Interval = function(node) {
	...
	haxe.Log.trace("new Inteval: " + Std.string(this.alternatives) + " " + Std.string(this.semitones),{ fileName : "ExerciseIntervals.hx", lineNumber : 61, className : "Interval", methodName : "new"});
	this.createUI();
...
Interval.prototype = {
	...
	,createWave: function() {
		...
		this1(function(wave) {
			haxe.Log.trace("WAVE :-)",{ fileName : "ExerciseIntervals.hx", lineNumber : 75, className : "Interval", methodName : "createWave"});
			haxe.Log.trace(wave.get_length(),{ fileName : "ExerciseIntervals.hx", lineNumber : 76, className : "Interval", methodName : "createWave"});
			_g.wave = wave;
		});
	}
	...
	,createUI: function() {
		var _g = this;
		haxe.Log.trace(this.semitones,{ fileName : "ExerciseIntervals.hx", lineNumber : 109, className : "Interval", methodName : "createUI"});
		...
		dtx.single.ElementManipulation.setAttr(playbutton,"class","nx-button nx-green");
		...
		while(_g1 < _g11.length) {
			...
			dtx.single.ElementManipulation.setAttr(abutton,"class","btn btn-primary btn-icon btn-circle btn-lg");
			dtx.single.ElementManipulation.setAttr(abutton,"style","margin:4px");
	...
	,newinterval: function(e,delay) {
		...
		haxe.Log.trace(Std.string([rnd,rndsemi,rnd1,rnd2,this.waveId]),{ fileName : "ExerciseIntervals.hx", lineNumber : 173, className : "Interval", methodName : "newinterval"});
		var diff;
		...
		window.setTimeout(function() {
			_g.info.textContent = "Ett nytt slumpintervall bestående av något av intervallen " + otheralts + " och " + lastalt + " har skapats. Klicka på playknappen för att höra intervallet spelas.";
		},delay);
	}
	...
	,createNotenrItems: function(rnd1,rnd2,diff) {
		if(diff == null) diff = 0;
		haxe.Log.trace("diff: " + diff,{ fileName : "ExerciseIntervals.hx", lineNumber : 204, className : "Interval", methodName : "createNotenrItems"});
	...
	,answer: function(a) {
		haxe.Log.trace("answer : " + a,{ fileName : "ExerciseIntervals.hx", lineNumber : 216, className : "Interval", methodName : "answer"});
		if(this.correct == a) {
			dtx.single.ElementManipulation.setInnerHTML(this.info,"<b>Rätt!</b> Vänta medan ett nytt slumpexempel skapas...");
			this.newinterval(null,1200);
...
$hxClasses["ExerciseManager"] = ExerciseManager;
ExerciseManager.__name__ = ["ExerciseManager"];
ExerciseManager.getInstance = function() {
	if(ExerciseManager.instance == null) return ExerciseManager.instance = new ExerciseManager(); else return ExerciseManager.instance;
};
ExerciseManager.prototype = {
	init: function() {
		var nodes = dtx.Tools.find(".nx-exercise");
		var $it0 = HxOverrides.iter(nodes.collection);
		while( $it0.hasNext() ) {
			var node = $it0.next();
			var type = dtx.single.ElementManipulation.attr(node,"data-type");
			if(type == null) continue;
			switch(type) {
			case "test":
				new ExerciseTest(node);
				break;
			default:
				js.Lib.alert("ExerciseManager: .nx-exercise node without data-type set");
			}
		}
	}
	,__class__: ExerciseManager
};
var ExerciseTest = function(parentNode) {
	this.parentNode = parentNode;
	var script = dtx.Tools.find(".nx-score").first();
	if(script == null) {
		js.Lib.alert("ExerciseTest: ScoreScript == null");
		return;
	}
	this.scriptScore = new nx3.utils.ScriptScoreX(script);
};
$hxClasses["ExerciseTest"] = ExerciseTest;
ExerciseTest.__name__ = ["ExerciseTest"];
ExerciseTest.prototype = {
	parentNode: null
	,scriptScore: null
	,__class__: ExerciseTest
};
...
Exercises.random = function(scoreId) {
	...
	(nx3.utils.ScriptScoresXInteraction.instance == null?nx3.utils.ScriptScoresXInteraction.instance = new nx3.utils.ScriptScoresXInteraction():nx3.utils.ScriptScoresXInteraction.instance).onInteractExternal = function(scriptScore,interaction) {
		...
		case 0:
			...
			var pn = pnote;
			var voice = pn.getVoice();
			var bar = voice.getPart().getBar();
			var noteidx;
			var _this = voice.getNotes();
			noteidx = HxOverrides.indexOf(_this,pnote,0);
			var baridx;
			var _this1 = bar.getScore().getBars();
			baridx = HxOverrides.indexOf(_this1,bar,0);
			var ninfo = noteinfo;
			if(ninfo.partnr > 0) note = bar.getPart(0).getVoice(0).getNote(noteidx).nnote;
...
Exercises.playRandom = function() {
	...
	this1(function(wav16) {
		haxe.Log.trace("FINISHED nscore1",{ fileName : "Exercises.hx", lineNumber : 217, className : "Exercises", methodName : "playRandom"});
...
app.ClientUI.initScores = function(id) {
	...
	window.setTimeout(function() {
		...
		(ExerciseManager.instance == null?ExerciseManager.instance = new ExerciseManager():ExerciseManager.instance).init();
...
audiotools.sound.Wav16SoundManager.prototype = {
	...
	,initSound: function(wav16,playCallback,key) {
		haxe.Log.trace(key,{ fileName : "Wav16SoundManager.hx", lineNumber : 29, className : "audiotools.sound.Wav16SoundManager", methodName : "initSound"});
		if(this.sound != null) this.sound.stop();
		if(wav16 == this.wav16 && playCallback == this.playCallback && key == this.key) {
			haxe.Log.trace("no need to re initialize",{ fileName : "Wav16SoundManager.hx", lineNumber : 32, className : "audiotools.sound.Wav16SoundManager", methodName : "initSound"});
			return;
		}
		this.wav16 = wav16;
		this.playCallback = playCallback;
	...
	,start: function(pos) {
		if(this.sound != null) this.sound.start(pos); else haxe.Log.trace("Wav16SoundManager has no sound instance",{ fileName : "Wav16SoundManager.hx", lineNumber : 54, className : "audiotools.sound.Wav16SoundManager", methodName : "start"});
	}
	,stop: function() {
		if(this.sound != null) this.sound.stop(); else haxe.Log.trace("Wav16SoundManager has no sound instance",{ fileName : "Wav16SoundManager.hx", lineNumber : 62, className : "audiotools.sound.Wav16SoundManager", methodName : "stop"});
	}
...
audiotools.utils.Wav16PartsBuilder.prototype = {
	...
	,getScoreWav16Async: function(nscore,tempo,partsSounds) {
		...
		if(this.scorecache.exists(key)) {
			haxe.Log.trace("Get wav16 from cache " + key,{ fileName : "Wav16PartsBuilder.hx", lineNumber : 201, className : "audiotools.utils.Wav16PartsBuilder", methodName : "getScoreWav16Async"});
			...
			this1(function(soundmap) {
				...
				haxe.Log.trace("Set wav16 to cache " + key,{ fileName : "Wav16PartsBuilder.hx", lineNumber : 210, className : "audiotools.utils.Wav16PartsBuilder", methodName : "getScoreWav16Async"});
				f.trigger(wav161);
			});
		}
		return f.future;
	...
	,getPartsnotesWav16Async: function(id,partsnotes,partsSounds) {
		...
		var key = id + "";
		if(this.scorecache.exists(key)) {
			haxe.Log.trace("Get wav16 from cache " + key,{ fileName : "Wav16PartsBuilder.hx", lineNumber : 225, className : "audiotools.utils.Wav16PartsBuilder", methodName : "getPartsnotesWav16Async"});
			var wav16 = this.scorecache.get(key);
			f.trigger(wav16);
		} else {
			var files = nx3.audio.NotenrTools.getPartsnotesMp3files(partsnotes,partsSounds);
			...
			this1(function(soundmap) {
				var wav161 = _g.buildSoundmap(partsnotes,soundmap);
				_g.scorecache.set(key,wav161);
				haxe.Log.trace("Set wav16 to cache " + key,{ fileName : "Wav16PartsBuilder.hx", lineNumber : 234, className : "audiotools.utils.Wav16PartsBuilder", methodName : "getPartsnotesWav16Async"});
				f.trigger(wav161);
			});
		}
		return f.future;
	...
	,removeScoreFromCache: function(nscore,tempo,partsSounds) {
		...
		if(this.scorecache.exists(key)) {
			...
			haxe.Log.trace("remove key " + key,{ fileName : "Wav16PartsBuilder.hx", lineNumber : 248, className : "audiotools.utils.Wav16PartsBuilder", methodName : "removeScoreFromCache"});
		} else haxe.Log.trace("can not find key " + key + " to remove",{ fileName : "Wav16PartsBuilder.hx", lineNumber : 250, className : "audiotools.utils.Wav16PartsBuilder", methodName : "removeScoreFromCache"});
	}
...
nx3.EModus = $hxClasses["nx3.EModus"] = { __ename__ : ["nx3","EModus"], __constructs__ : ["Major","Minor"] };
...
nx3.EModus.__empty_constructs__ = [nx3.EModus.Major,nx3.EModus.Minor];
...
nx3.EOctave = $hxClasses["nx3.EOctave"] = { __ename__ : ["nx3","EOctave"], __constructs__ : ["Normal","Up","Down"] };
...
nx3.EOctave.__empty_constructs__ = [nx3.EOctave.Normal,nx3.EOctave.Up,nx3.EOctave.Down];
...
nx3.EPartType.__empty_constructs__ = [nx3.EPartType.Normal,nx3.EPartType.Lyrics,nx3.EPartType.Dynamics,nx3.EPartType.Chords,nx3.EPartType.Ignore,nx3.EPartType.Hidden,nx3.EPartType.PitchRow];
...
nx3.audio.NotenrTools.debug = function(partsnotes) {
	haxe.Log.trace("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - ",{ fileName : "NotenrTools.hx", lineNumber : 220, className : "nx3.audio.NotenrTools", methodName : "debug"});
	var _g = 0;
	while(_g < partsnotes.length) {
		var part = partsnotes[_g];
		++_g;
		haxe.Log.trace("Part: ",{ fileName : "NotenrTools.hx", lineNumber : 222, className : "nx3.audio.NotenrTools", methodName : "debug"});
		var _g1 = 0;
		while(_g1 < part.length) {
			var note = part[_g1];
			++_g1;
			haxe.Log.trace([note.barnr,note.position,note.midinr,note.noteval],{ fileName : "NotenrTools.hx", lineNumber : 224, className : "nx3.audio.NotenrTools", methodName : "debug"});
		}
	}
};
		...
		var y = this.targetY + (system.getY() + part_getYPosition) * this.target.getScaling().unitY;
		{
			...
			case 3:
				...
				if(pause) {
					...
					haxe.Log.trace(numSvgStr,{ fileName : "Renderer.hx", lineNumber : 579, className : "nx3.render.Renderer", methodName : "drawNoteHeads"});
				}
				var tx;
...
nx3.render.TargetSvgXml.prototype = {
	...
	,textwidth: function(text) {
		if(this.context == null) {
			var canvas = window.document.getElementById("CanvasTextMeasurement");
			if(canvas == null) {
				haxe.Log.trace("creating a canvas for text measurement",{ fileName : "TargetSvgXml.hx", lineNumber : 351, className : "nx3.render.TargetSvgXml", methodName : "textwidth"});
				var _this = window.document;
...
nx3.utils.ScriptScoreX = function(scriptElement) {
	...
	haxe.Log.trace(nx3.xml.ScoreXML.toXml(this.nscore).toString(),{ fileName : "ScriptScoreX.hx", lineNumber : 61, className : "nx3.utils.ScriptScoreX", methodName : "new"});
	...
	haxe.Log.trace(this.sounds,{ fileName : "ScriptScoreX.hx", lineNumber : 69, className : "nx3.utils.ScriptScoreX", methodName : "new"});
...
nx3.utils.ScriptScoreX.prototype = {
	...
	,addHandlers: function() {
		...
		canvas.onmousedown = function(e4) {
			...
			haxe.Log.trace(sound,{ fileName : "ScriptScoreX.hx", lineNumber : 352, className : "nx3.utils.ScriptScoreX", methodName : "addHandlers"});
...
nx3.utils.ScriptScoresXInteraction.prototype = {
	...
	,onPlay: function(scriptScore) {
		haxe.Log.trace("play " + scriptScore.id,{ fileName : "ScriptScoresXInteraction.hx", lineNumber : 35, className : "nx3.utils.ScriptScoresXInteraction", methodName : "onPlay"});
	...
	,startPlayAt: null
	,started: null
	,MINIMUM_MOUSEDOWN_PLAY_TIME: null
	...
	,onInteractExternal: null
	,currentActive: null
	,activateScore: function(scriptScore) {
		if(this.currentActive == scriptScore) return;
		(audiotools.sound.Wav16SoundManager.instance == null?audiotools.sound.Wav16SoundManager.instance = new audiotools.sound.Wav16SoundManager():audiotools.sound.Wav16SoundManager.instance).stop();
		haxe.Log.trace("activate",{ fileName : "ScriptScoresXInteraction.hx", lineNumber : 91, className : "nx3.utils.ScriptScoresXInteraction", methodName : "activateScore"});
...
nx3.xml.NoteXML.test = function(item) {
	...
	haxe.Log.trace(str,{ fileName : "NoteXML.hx", lineNumber : 245, className : "nx3.xml.NoteXML", methodName : "test"});
	haxe.Log.trace(str2,{ fileName : "NoteXML.hx", lineNumber : 246, className : "nx3.xml.NoteXML", methodName : "test"});
	return str == str2;
};
